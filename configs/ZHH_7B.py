...
# SAVE_CKPT_FOLDER = "/share/work/sh/work/20241016/InternEvo/ckpt"
# LOAD_CKPT_FOLDER = "/share/work/sh/work/20241016/weight/Chameleon_7B_mGPT"
...
ckpt = dict(
    ...
    # load_ckpt_info= dict(path=LOAD_CKPT_FOLDER, content=["model"], ckpt_type="hf"),
