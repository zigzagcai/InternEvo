...
# Modefied from
# https://github.com/Alpha-VLLM/Lumina-mGPT/blob/104abe453ec1acca5863698629c4db2111b0b3fc/lumina_mgpt/model/chameleon/modeling_chameleon.py#L593C1-L666C23
class ChameleonDecoderLayer(nn.Module):
    def __init__(self,
        ...
        self.self_attn = GQA(embed_dim=hidden_size,
        ...
        self.mlp = new_feed_forward(
                ...
                bias=mlp_bias,
                activation_type=hidden_act)

        self.input_layernorm = new_layer_norm("rmsnorm", hidden_size, rms_norm_eps)
        self.post_attention_layernorm = new_layer_norm("rmsnorm", hidden_size, rms_norm_eps)
